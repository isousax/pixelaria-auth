/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bba1d0cad432ca7eae538d5f043f8176)
// Runtime types generated with workerd@1.20250726.0 2025-09-23 
declare namespace Cloudflare {
	interface Env {
		SITE_DNS: "https://dns.com.br";
		EMAIL_FROM: "Name <no-reply@dns.com.br>";
		EMAIL_REPLY_TO: "email@gmail.com";
		JWT_EXPECTED_ISSUER: "https://dns.com.br";
		JWT_EXPECTED_AUDIENCE: "https://dns.com.br";
		JWT_JWKS_KID: "k1";
		JWT_EXPIRATION_SEC: 3600;
		ME_CACHE_TTL_MS: 3600;
		REFRESH_TOKEN_EXPIRATION_DAYS: 30;
		FRONTEND_URL: "https://avantenutri.com.br";
		WEBHOOK_URL: "https://webhook-proxy-eosin.vercel.app/api/mp-proxy-avante-nutri";
		DB: D1Database;
	}
}
